            ...
            VStack {
                ...
                VStack {
                    ...
                    ZStack {
                        ...
                        Text(viewModel.selectedCourse?.cTitle ?? "")
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    ...
                    VStack(spacing: 10) {
                        ...
                        VStack(spacing: 14) {
                            ...
                            Text(viewModel.selectedCourse?.cDetails ?? "")
                                .foregroundColor(.black)
                                .font(.system(size: 26, weight: .regular))
                            
                            HStack {
                                
                                Text("\(viewModel.selectedCourse?.cStart ?? ""), \(viewModel.selectedCourse?.cDuration ?? "")")
                                    .foregroundColor(.gray)
                                    .font(.system(size: 16, weight: .regular))
                                
                                Spacer()
                                
                                Text("$\(viewModel.selectedCourse?.cType ?? "")")
            ...
            ZStack {
                ...
                VStack {
                    ...
                    Button(action: {
                        ...
                        CoreDataStack.shared.deleteCourses(withCTitle: viewModel.selectedCourse?.cTitle ?? "", completion: {
